  ...
  return (
    <div className="bg-white border border-gray-200 rounded-xl p-6 flex items-start justify-between shadow-sm">
      <div className="space-y-1">
        ...
        <p
          className={`text-xs font-medium ${type === "alert" ? "text-red-500" : "text-gray-400"}`}
        >
          {sub}
        </p>
      </div>
...
const DashboardPage = ({ onNavigate, pendingList = [] }) => {
    ...
    <div className="w-full space-y-6 pb-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          icon={
            ...
            >
              <path
                ...
                d="M15 19.128a9.38 9.38 0 002.625.372 9.337 9.337 0 004.121-.952 4.125 4.125 0 00-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.109A11.386 11.386 0 0110.089 18M14.214 16.058A9.394 9.394 0 0010 15.14c-2.133 0-4.054.712-5.586 1.918A4.125 4.125 0 001.07 19.57a9.333 9.333 0 008.267 1.058m7.414-16.141a3 3 0 11-5.714 0M12 7a3 3 0 11-6 0"
              />
            </svg>
          }
        />
        <StatCard
          ...
          type={pendingList.length > 0 ? "alert" : "info"}
          icon={
            <svg
              className={`w-6 h-6 ${pendingList.length > 0 ? "text-red-500 animate-pulse" : "text-gray-400"}`}
              fill="none"
              viewBox="0 0 24 24"
              stroke="currentColor"
              strokeWidth={2}
        ...
        <div className="overflow-x-auto">
          {pendingList.length === 0 ? (
            <div className="text-center py-8 text-gray-450 text-xs">
              ...
              Tidak ada antrian verifikasi yang tertunda.
            </div>
          ) : (
